...
export const assignProductCategory = async (
    id: number,
    payload: AssignCategoryInput,
): Promise<Product> =>
    (await api.patch<Product>(`/products/${id}/categoria`, payload)).data;

export const assignProductBrand = async (
    id: number,
    payload: AssignBrandInput,
): Promise<Product> =>
    (await api.patch<Product>(`/products/${id}/marca`, payload)).data;

export const assignProductIngredients = async (
    id: number,
    payload: AssignIngredientsInput,
): Promise<Product> =>
...
export const uploadProductImage = async (
    ...
    return (
        await api.post<ProductImage>(`/products/${id}/imagenes`, form, {
