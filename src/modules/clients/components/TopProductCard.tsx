...
const TopProductCard: React.FC<TopProductCardProps> = ({ product, onAddToCart }) => {
    ...
    return (
        <div className="w-44 flex-shrink-0 group p-3 flex flex-col items-center">
            ...
            <button 
                className="bg-black text-white text-xs px-3 py-1 mt-2 cursor-pointer font-mono tracking-tight rounded transition-all duration-200 hover:bg-primary hover:text-primary-foreground"
