...
const ClientCatalogPage = () => {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      <aside className="w-64 bg-client text-client-foreground p-8 flex-shrink-0 border border-border">
      ...
      <div className="flex-1 flex flex-col p-8">
        <section className="bg-client text-client-foreground w-full px-8 py-6 mb-8 border border-border">
