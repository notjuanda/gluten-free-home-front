...
import { createCategorySchema, type CreateCategorySchema } from '../../schemas/create-category.schema';
import { useCreateCategory } from '../../hooks/categories/useCreateCategory';
import { FiGrid, FiX } from 'react-icons/fi';
import clsx from 'clsx';
import type { CreateCategoryModalProps } from '../../types/categories-components.type';

export default function CreateCategoryModal({ open, onClose, onCreated }: CreateCategoryModalProps) {
    ...
    return (
        ...
        >
            ...
            <h2 className="font-extrabold text-xl text-foreground">Crear categoría</h2>
            </div>
