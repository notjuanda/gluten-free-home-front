...
import { createBrandSchema, type CreateBrandSchema } from '../../schemas/create-brand.schema';
import { useCreateBrand } from '../../hooks/brands/useCreateBrand';
import { FiTag, FiX } from 'react-icons/fi';
import clsx from 'clsx';
import type { CreateBrandModalProps } from '../../types/brands-components.type';

export default function CreateBrandModal({ open, onClose, onCreated }: CreateBrandModalProps) {
    const { register, handleSubmit, formState: { errors }, reset } = useForm<CreateBrandSchema>({
    ...
    return (
        ...
        >
            ...
            <h2 className="font-extrabold text-xl text-foreground">Crear marca</h2>
            </div>
